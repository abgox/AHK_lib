 ...
 *  arr_findIndex([4, 5, 6], v => v > 5, -2) ; return 3
 *  arr_findIndex([4, 5, 6], v => v > 5, 1, 3) ; return ""
 *  arr_findIndex([4, 5, 6], v => v > 5, 1, 4) ; return 3
 *  arr_findIndex(['aa', 'cc', 'ccc'], v => InStr(v,'c')) ; return 2
 */
arr_findIndex(arr, callback, start := 1, end := arr.Length + 1) {
    ;@Ahk2Exe-IgnoreBegin
    if (Type(arr) != 'Array') {
